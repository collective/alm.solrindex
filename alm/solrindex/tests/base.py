...
#from alm.content.tests.utils import MockMailHost
#from alm.content.tests.utils import MockVocabularyTool
...
def setup_product():
    ...
    ztc.installPackage('alm.solrindex')
...
#class Layer(tcl_ptc.BasePTCLayer):
    ...
    #def afterSetUp(self):
        #self.addProfile('alm.solrindex:initial')
        #self.addProfile('alm.solrindex:default')
